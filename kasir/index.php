  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="../#">KASIR-TOKO BUKU (<?= $profil['nama'] ?>)</a>
      </div>
    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar">
        ...
        <ul class="nav nav-sidebar">
          ...
          <li <?php if ($menu == "input_penjualan" || $menu == "load_buku" || $menu == "selesai") {
                echo "class='active'";
              } ?>><a href="?menu=input_penjualan">Input Penjual</a></li>
