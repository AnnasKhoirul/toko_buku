    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar">
        ...
        <ul class="nav nav-sidebar">
          ...
          <li <?php if ($menu == "data_pegawai" || $menu == "tambah_pegawai" || $menu == "edit_pegawai") {
                echo "class='active'";
              } ?>><a href="?menu=data_pegawai">Data Pegawai</a></li>
          <li <?php if ($menu == "data_buku" || $menu == "tambah_buku" || $menu == "edit_buku") {
                echo "class='active'";
              } ?>><a href="?menu=data_buku">Buku</a></li>
          ...
          <li <?php if ($menu == "data_penjualan") {
                echo "class='active'";
              } ?>><a href="?menu=data_penjualan">Laporan Penjualan</a></li>
        </ul>
        <ul class="nav nav-sidebar">
          <li class="active"><a onclick="return confirm('Anda yakin akan keluar?')" href="../inc/keluar.php">
              <span class="glyphicon glyphicon-log-out"></span> Keluar <span class="sr-only">(current)</span></a></li>
        </ul>
      </div>
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        switch ($_GET['menu']) {
          ...
          case 'hapus_pegawai':
            $id = $_GET['id_pegawai'];
            mysqli_query($koneksi, "DELETE FROM tb_kasir WHERE id_kasir='$id'");
            include "menu/data_pegawai.php";
            break;
          ...
          case 'hapus_distributor':
            ...
            mysqli_query($koneksi, "DELETE FROM tb_distributor WHERE id_distributor='$id'");
            include "menu/data_distributor.php";
            break;
